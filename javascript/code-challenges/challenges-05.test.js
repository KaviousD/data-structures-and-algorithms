...
const addValues = (arr) => {
  ...
  return arr.reduce((accumulator, currentValue) =>
    accumulator + currentValue, valueFun);
};
/* ------------------------------------------------------------------------------------------------
CHALLENGE 3
...
const addPurchases = (arr) => {
  ...
  accumulator + currentValue, purchases);
};
...
const reversedString = (str) => {
  // Solution code here...
  let srgString = str.split('');
  let revString = srgString.reverse();
  let combine = revString.join('');
  return combine;
};
